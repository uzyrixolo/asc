...
<?php
	...
	movedo_grve_print_header_breadcrumbs( 'search_page' );
...
<!-- CONTENT -->
<div id="grve-content" class="clearfix <?php echo movedo_grve_sidebar_class( 'search_page' ); ?>">
	<div class="grve-content-wrapper">
		...
		<!-- END MAIN CONTENT -->
		<?php movedo_grve_set_current_view( 'search_page' ); ?>
		<?php get_sidebar(); ?>
	</div>
</div>
<?php get_footer();
