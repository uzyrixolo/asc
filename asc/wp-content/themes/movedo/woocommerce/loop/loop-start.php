...
$columns_tablet_landscape = movedo_grve_option( 'product_loop_columns_tablet_landscape', '2' );
$columns_tablet_portrait = movedo_grve_option( 'product_loop_columns_tablet_portrait', '2' );
$columns_mobile = movedo_grve_option( 'product_loop_columns_mobile', '1' );
