...
<div class="product_meta">
	...
	<?php if ( wc_product_sku_enabled() && ( $product->get_sku() || $product->is_type( 'variable' ) ) ) : ?>
		...
		<span class="grve-single-product-meta sku_wrapper"><span class="grve-h6"><?php esc_html_e( 'SKU:', 'woocommerce' ); ?></span> <span class="sku"><?php echo wp_kses_post( $sku ); ?></span></span>
	...
	<?php
		if ( function_exists( 'wc_get_product_category_list' ) ) {
			...
			echo get_the_term_list( $product_get_id, 'product_cat', '<span class="posted_in"><span class="grve-h6">' . _n( 'Category:', 'Categories:', $cat_count, 'woocommerce' ) . '</span> ', ', ', '</span>');
		}
	?>
	</div>
