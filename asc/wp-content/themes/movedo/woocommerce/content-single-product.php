...
if( 'theme' == movedo_grve_option( 'product_image_thumb_style', 'theme' ) && '1' == movedo_grve_option( 'product_image_middle', '1' ) ) {
	$section_classes[] = 'grve-middle-content';
...
<div id="product-<?php the_ID(); ?>" <?php wc_product_class('grve-product-area', $product ); ?>>
<?php } else { ?>
