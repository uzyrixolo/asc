<?php
	...
	echo '<div class="' . esc_attr( $column_wrapper_string ) . '" ' . $data_column_wrapper_string . '>';
	if( $vertical_content_position != 'top' ) {
		echo '<div class="grve-column-content">';
	}
	if ( !empty( $block_content ) && !movedo_grve_is_privacy_key_enabled( $block_content ) ) {
		echo movedo_grve_privacy_disable_fallback( $block_content );
	} else {
