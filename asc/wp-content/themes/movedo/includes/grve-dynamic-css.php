...
if ( 'framed' == $movedo_grve_theme_layout ) {
	...
	@media only screen and (min-width: " . esc_attr( $movedo_grve_responsive_header_threshold ) . "px) {
		...
		.grve-back-top {
			bottom: -" . ( esc_attr( $movedo_grve_frame_size ) + 60 ) . "px;
			right: " . ( esc_attr( $movedo_grve_frame_size ) + 20 ) . "px;
		}
		.grve-back-top.show {
			-webkit-transform: translate(0, -" . ( esc_attr( $movedo_grve_frame_size * 2  ) + 80 ) . "px);
			-moz-transform:    translate(0, -" . ( esc_attr( $movedo_grve_frame_size * 2  ) + 80 ) . "px);
			-ms-transform:     translate(0, -" . ( esc_attr( $movedo_grve_frame_size * 2  ) + 80 ) . "px);
			-o-transform:      translate(0, -" . ( esc_attr( $movedo_grve_frame_size * 2  ) + 80 ) . "px);
			transform:         translate(0, -" . ( esc_attr( $movedo_grve_frame_size * 2  ) + 80 ) . "px);
		}
...
/* GDPR Privacy
============================================================================= */
$movedo_grve_privacy_bar_bg_color = movedo_grve_option( 'privacy_bar_bg_color', '#000000' );
$css .= "

#grve-privacy-bar {
	background-color: rgba(" . movedo_grve_hex2rgb( $movedo_grve_privacy_bar_bg_color ) . "," . movedo_grve_option( 'privacy_bar_bg_opacity', '0.90') . ");
	color: " . movedo_grve_option( 'privacy_bar_text_color' ) . ";
}

.grve-privacy-agreement {
	background-color: " . movedo_grve_option( 'privacy_bar_button_bg_color' ) . ";
	color: " . movedo_grve_option( 'privacy_bar_button_text_color' ) . ";
}

.grve-privacy-refresh-btn {
	background-color: " . movedo_grve_option( 'privacy_modal_button_bg_color' ) . ";
	color: " . movedo_grve_option( 'privacy_modal_button_text_color' ) . ";
}
...
.grve-privacy-agreement:hover {
	background-color: " . movedo_grve_option( 'privacy_bar_button_bg_hover_color' ) . ";
}

.grve-privacy-refresh-btn:hover {
	background-color: " . movedo_grve_option( 'privacy_modal_button_bg_hover_color' ) . ";
}
