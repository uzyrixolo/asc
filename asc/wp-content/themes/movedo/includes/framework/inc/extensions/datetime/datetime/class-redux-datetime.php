...
if ( ! class_exists( 'Redux_Datetime', false ) ) {
	...
	class Redux_Datetime extends Redux_Field {
		...
		public function render() {
			...
			if ( true === $split ) {
				$date_placeholder = $this->field['placeholder']['date'] ?? __( 'Date', 'redux-framework' );
				$time_placeholder = $this->field['placeholder']['time'] ?? __( 'Time', 'redux-framework' );
			} else {
				$date_placeholder = $this->field['placeholder'] ?? __( 'Date / Time', 'redux-framework' );
			}
