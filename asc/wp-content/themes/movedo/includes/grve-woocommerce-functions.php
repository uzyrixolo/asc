 ...
 */
if ( !function_exists('movedo_grve_woo_product_search') ) {
...
if ( !function_exists('movedo_grve_woo_mini_cart') ) {
...
if ( !function_exists('movedo_grve_woo_header_add_to_cart_fragment') ) {
...
if ( !function_exists('movedo_grve_woo_product_review_comment_form_args') ) {
 ...
 */
if ( !function_exists('movedo_grve_woo_before_main_content') ) {
 ...
 */
if ( !function_exists('movedo_grve_woo_after_main_content') ) {
...
if ( !function_exists('movedo_grve_woo_tags_single_meta') ) {
...
function movedo_grve_woo_theme_setup() {

	$product_image_thumb_style = movedo_grve_option( 'product_image_thumb_style', 'theme' );
	if( 'woo' == $product_image_thumb_style ) {
		if( movedo_grve_visibility( 'product_gallery_woo_zoom' ) ) {
			add_theme_support( 'wc-product-gallery-zoom' );
		}
		if( movedo_grve_visibility( 'product_gallery_woo_lightbox' ) ) {
			add_theme_support( 'wc-product-gallery-lightbox' );
		}
		if( movedo_grve_visibility( 'product_gallery_woo_slider' ) ) {
			add_theme_support( 'wc-product-gallery-slider' );
		}
	}

}
add_action( 'after_setup_theme', 'movedo_grve_woo_theme_setup' );
