...
function movedo_grve_sidebar_class( $sidebar_view = '' ) {
	...
	$movedo_grve_sidebar_class = apply_filters( 'movedo_grve_sidebar_class', $movedo_grve_sidebar_class, $sidebar_view );
	...
	function movedo_grve_nav_bar( $post_type = 'post', $mode = '') {
		...
		if ( 'product' == $post_type ) {
			...
			if (  function_exists( 'tribe' ) ) {
				$prev_post = tribe( 'tec.adjacent-events' )->get_closest_event( 'previous' ) ;
				$next_post = tribe( 'tec.adjacent-events' )->get_closest_event( 'next' ) ;
			}
...
if ( !function_exists('movedo_grve_social_bar') ) {
	function movedo_grve_social_bar( $post_type = 'post', $mode = '' ) {
		...
		?>
					...
					<li><a href="<?php echo esc_url( $grve_permalink ); ?>" title="<?php echo esc_attr( $grve_title ); ?>" class="grve-social-share-twitter">X</a></li>
					<?php } ?>
		...
		?>
					<?php if ( !empty( $grve_email  ) ) { ?>
					<li><a href="<?php echo esc_url( $grve_email_string ); ?>" title="<?php echo esc_attr( $grve_title ); ?>" class="grve-social-share-email"><i class="fas fa-envelope"></i></a></li>
					<?php } ?>
					<?php if ( !empty( $grve_facebook  ) ) { ?>
					<li><a href="<?php echo esc_url( $grve_permalink ); ?>" title="<?php echo esc_attr( $grve_title ); ?>" class="grve-social-share-facebook"><i class="fab fa-facebook"></i></a></li>
					<?php } ?>
					<?php if ( !empty( $grve_twitter  ) ) { ?>
					<li><a href="<?php echo esc_url( $grve_permalink ); ?>" title="<?php echo esc_attr( $grve_title ); ?>" class="grve-social-share-twitter"><i class="fab fa-x-twitter"></i></a></li>
					<?php } ?>
					<?php if ( !empty( $grve_linkedin  ) ) { ?>
					<li><a href="<?php echo esc_url( $grve_permalink ); ?>" title="<?php echo esc_attr( $grve_title ); ?>" class="grve-social-share-linkedin"><i class="fab fa-linkedin"></i></a></li>
					<?php } ?>
					<?php if ( !empty( $grve_pinterest  ) ) { ?>
					<li><a href="<?php echo esc_url( $grve_permalink ); ?>" title="<?php echo esc_attr( $grve_title ); ?>" data-pin-img="<?php echo esc_url( movedo_grve_get_thumbnail_url() ); ?>" class="grve-social-share-pinterest"><i class="fab fa-pinterest"></i></a></li>
					<?php } ?>
					<?php if ( !empty( $grve_reddit ) ) { ?>
					<li><a href="<?php echo esc_url( $grve_permalink ); ?>" title="<?php echo esc_attr( $grve_title ); ?>" class="grve-social-share-reddit"><i class="fab fa-reddit"></i></a></li>
					<?php } ?>
					<?php if ( !empty( $grve_tumblr ) ) { ?>
					<li><a href="<?php echo esc_url( $grve_permalink ); ?>" title="<?php echo esc_attr( $grve_title ); ?>" class="grve-social-share-tumblr"><i class="fab fa-tumblr"></i></a></li>
					<?php } ?>
					<?php if ( !empty( $grve_likes  ) ) { ?>
					<li><a href="#" class="grve-like-counter-link <?php echo movedo_grve_likes( $post_id, 'status' ); ?>" data-post-id="<?php echo esc_attr( $post_id ); ?>"><i class="fas fa-heart"></i><span class="grve-like-counter"><?php echo movedo_grve_likes( $post_id, 'number' ); ?></span></a></li>
					<?php } ?>
		<?php
			}
		?>
