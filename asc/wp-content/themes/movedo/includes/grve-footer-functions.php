							...
							if ( 'text' == $social_display ) {
								...
								foreach ( $social_options as $key => $value ) {
									if ( isset( $social_list_extended[$key] ) && isset( $options[$key] ) && 1 == $options[$key] && $value ) {
										if ( 'skype' == $key ) {
											echo '<li><a href="' . esc_url( $value, array( 'skype', 'http', 'https' ) ) . '">' . $social_list_extended[$key]['title'] . '</a></li>';
										} else {
											echo '<li><a href="' . esc_url( $value ) . '" target="_blank" rel="' . implode( ' ', $social_rel ) . '">' . $social_list_extended[$key]['title'] . '</a></li>';
										}
									}
								}
								echo '</ul>';
