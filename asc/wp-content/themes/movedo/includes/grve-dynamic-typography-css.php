...
$movedo_grve_responsive_fonts_group_2 =  array (
	...
	array(
		'id'   => 'link_text',
		'selector'  => '#grve-theme-wrapper .grve-link-text,#grve-theme-wrapper a.grve-btn,#grve-theme-wrapper input[type="submit"],#grve-theme-wrapper input[type="reset"],#grve-theme-wrapper button:not(.mfp-arrow):not(.grve-search-btn),#cancel-comment-reply-link,#reply-title',
	),
	array(
		'id'   => 'main_menu_font',
	...
	array(
		'id'   => 'sub_menu_font',
		'selector'  => '.grve-slide-menu .grve-main-menu .grve-wrapper ul li.megamenu ul li:not(.grve-goback) > a, .grve-main-menu .grve-wrapper > ul > li ul li a',
	),
	array(
	...
	array(
		'id'   => 'hidden_menu_font',
		'selector'  => '#grve-hidden-menu .grve-hiddenarea-content .grve-menu > li > a,#grve-hidden-menu .grve-hiddenarea-content .grve-menu > li > .grve-toggle-menu-item-wrapper a,#grve-responsive-anchor .grve-hiddenarea-content .grve-menu > li > a,#grve-hidden-menu ul.grve-menu > li.megamenu > ul > li > a,#grve-hidden-menu ul.grve-menu > li ul li.grve-goback a',
	),
	array(
...
$typo_css .= "
	@media only screen and (min-width: 1201px) and (max-width: 1440px) {
		" . movedo_grve_print_typography_responsive( $movedo_grve_responsive_fonts_group_headings, $small_desktop_threshold_headings, $small_desktop_ratio_headings, 'desktop-sm' ). "
		" . movedo_grve_print_typography_responsive( $movedo_grve_responsive_fonts_group_1, $small_desktop_threshold, $small_desktop_ratio, 'desktop-sm' ). "
		" . movedo_grve_print_typography_responsive( $movedo_grve_responsive_fonts_group_2, $small_desktop_threshold2, $small_desktop_ratio2, 'desktop-sm' ). "
	}
	@media only screen and (min-width: 960px) and (max-width: 1200px) {
		" . movedo_grve_print_typography_responsive( $movedo_grve_responsive_fonts_group_headings, $tablet_landscape_threshold_headings, $tablet_landscape_ratio_headings, 'tablet'  ). "
		" . movedo_grve_print_typography_responsive( $movedo_grve_responsive_fonts_group_1, $tablet_landscape_threshold, $tablet_landscape_ratio, 'tablet'   ). "
		" . movedo_grve_print_typography_responsive( $movedo_grve_responsive_fonts_group_2, $tablet_landscape_threshold2, $tablet_landscape_ratio2, 'tablet'   ). "
	}
	@media only screen and (min-width: 768px) and (max-width: 959px) {
		" . movedo_grve_print_typography_responsive( $movedo_grve_responsive_fonts_group_headings, $tablet_portrait_threshold_headings, $tablet_portrait_ratio_headings, 'tablet-sm' ). "
		" . movedo_grve_print_typography_responsive( $movedo_grve_responsive_fonts_group_1, $tablet_portrait_threshold, $tablet_portrait_ratio, 'tablet-sm' ). "
		" . movedo_grve_print_typography_responsive( $movedo_grve_responsive_fonts_group_2, $tablet_portrait_threshold2, $tablet_portrait_ratio2, 'tablet-sm' ). "
	}
	@media only screen and (max-width: 767px) {
		" . movedo_grve_print_typography_responsive( $movedo_grve_responsive_fonts_group_headings, $mobile_threshold_headings, $mobile_ratio_headings, 'mobile' ). "
		" . movedo_grve_print_typography_responsive( $movedo_grve_responsive_fonts_group_1, $mobile_threshold, $mobile_ratio, 'mobile' ). "
		" . movedo_grve_print_typography_responsive( $movedo_grve_responsive_fonts_group_2, $mobile_threshold2, $mobile_ratio2, 'mobile' ). "
	}
	@media print {
		" . movedo_grve_print_typography_responsive( $movedo_grve_responsive_fonts_group_headings, $mobile_threshold_headings, $mobile_ratio_headings, 'print' ). "
		" . movedo_grve_print_typography_responsive( $movedo_grve_responsive_fonts_group_1, $mobile_threshold, $mobile_ratio, 'print'  ). "
		" . movedo_grve_print_typography_responsive( $movedo_grve_responsive_fonts_group_2, $mobile_threshold2, $mobile_ratio2, 'print'  ). "
	}
";
