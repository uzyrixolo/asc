...
if ( !function_exists('movedo_grve_validate_header_style') ) {
 ...
 */
if ( !function_exists('movedo_grve_get_feature_header_data') ) {
 ...
 */
if ( !function_exists('movedo_grve_print_header_feature') ) {
 ...
 */
if ( !function_exists('movedo_grve_print_overlay_container') ) {
 ...
 */
if ( !function_exists('movedo_grve_print_bg_image_container') ) {
 ...
 */
if ( !function_exists('movedo_grve_print_bg_video_container') ) {
	function movedo_grve_print_bg_video_container( $item ) {
		...
		if ( movedo_grve_browser_webkit_check() ) {
			$muted = 'yes';
		}
 ...
 */
if ( !function_exists('movedo_grve_print_bg_youtube_container') ) {
 ...
 */
if ( !function_exists('movedo_grve_print_bottom_seperator_container') ) {
 ...
 */
if ( !function_exists('movedo_grve_get_feature_data') ) {
 ...
 * Get Feature Section data
 */
if ( !function_exists('movedo_grve_get_feature_height') ) {
 ...
 */
if ( !function_exists('movedo_grve_print_header_feature_single') ) {
 ...
 */
if ( !function_exists('movedo_grve_print_header_feature_slider') ) {
 ...
 */
if ( !function_exists('movedo_grve_print_header_feature_map') ) {
	...
	?>
		<div id="grve-feature-section" <?php echo implode( ' ', $feature_data ); ?>>
			<div class="grve-map grve-wrapper clearfix" <?php echo movedo_grve_get_feature_height( $feature_settings ); ?> <?php echo implode( ' ', $map_attributes ); ?>><?php echo apply_filters( 'movedo_grve_privacy_gmap_fallback', '', $map_lat, $map_lng ); ?></div>
			<?php
...
if ( !function_exists('movedo_grve_print_feature_map_point') ) {
 ...
 */
if ( !function_exists('movedo_grve_print_header_feature_revslider') ) {
 ...
 */
if ( !function_exists('movedo_grve_print_header_feature_content') ) {
 ...
 */
if ( !function_exists('movedo_grve_print_feature_button') ) {
