...
#grve-theme-wrapper #tribe-bar-collapse-toggle {
    display: none;
}
";
...
$css .= "
#grve-theme-wrapper .tribe-events-cal-links .tribe-events-gcal,
#grve-theme-wrapper .tribe-events-cal-links .tribe-events-ical {
	background-color: " . movedo_grve_option( 'body_primary_1_color' ) . ";
	color: #ffffff;
	display: inline-block;
	padding: 6px 12px;
...
#grve-theme-wrapper .tribe-events-cal-links .tribe-events-gcal:hover,
#grve-theme-wrapper .tribe-events-cal-links .tribe-events-ical:hover {
	opacity: 0.7;
}
";
/**
