 ...
 * Prints excerpt
 */
if ( !function_exists('movedo_grve_print_post_excerpt') ) {
...
if ( !function_exists('movedo_grve_isotope_inner_before') ) {
...
if ( !function_exists('movedo_grve_isotope_inner_after') ) {
...
if ( !function_exists('movedo_grve_get_loop_title_heading_tag') ) {
...
if ( !function_exists('movedo_grve_get_loop_title_heading') ) {
...
if ( !function_exists('movedo_grve_loop_post_title') ) {
...
if ( !function_exists('movedo_grve_loop_post_title_link') ) {
	function movedo_grve_loop_post_title_link() {
		$title_tag = movedo_grve_get_loop_title_heading_tag();
		$title_class = movedo_grve_get_loop_title_heading();
		the_title( '<a href="' . esc_url( get_permalink() ) . '" rel="bookmark"><' . tag_escape( $title_tag ) . ' class="grve-post-title grve-post-title-hover grve-' . esc_attr( $title_class ) . '" itemprop="headline">', '</' . tag_escape( $title_tag ) . '></a>' );
	}
}
if ( !function_exists('movedo_grve_loop_post_title_hidden') ) {
 ...
 */
if ( !function_exists('movedo_grve_print_post_simple_title') ) {
 ...
 * Gets Blog Class
 */
if ( !function_exists('movedo_grve_get_blog_class') ) {
 ...
 * Gets post class
 */
if ( !function_exists('movedo_grve_get_post_class') ) {
 ...
 */
if ( !function_exists('movedo_grve_print_blog_data') ) {
 ...
 */
if ( !function_exists('movedo_grve_print_post_feature_media') ) {
...
if ( !function_exists('movedo_grve_get_blog_image_atts') ) {
 ...
 */
if ( !function_exists('movedo_grve_print_post_feature_image') ) {
...
?>
			<div class="grve-post-header">
				...
				<?php movedo_grve_print_post_loop_categories(); ?>
 ...
 * Prints Post Tags
 */
if ( !function_exists('movedo_grve_print_post_tags') ) {
 ...
 */
if ( !function_exists('movedo_grve_print_post_title_categories') ) {
	function movedo_grve_print_post_title_categories( $post_id = null) {
		...
		if ( !empty( $post_terms ) && !is_wp_error( $post_terms ) ) {
			...
			$args = apply_filters( 'movedo_grve_post_categories_args', $args );
 ...
 */
if ( !function_exists('movedo_grve_print_post_title_categories_simple') ) {
 ...
 */
if ( !function_exists('movedo_grve_print_post_title_meta') ) {
 ...
 * Prints Post Title Meta
 */
if ( !function_exists('movedo_grve_print_feature_post_title_meta') ) {
 ...
 */
if ( !function_exists('movedo_grve_print_post_author_by') ) {
 ...
 */
if ( !function_exists('movedo_grve_print_like_counter_overview') ) {
 ...
 * Prints like counter
 */
if ( !function_exists('movedo_grve_print_like_counter') ) {
...
if ( !function_exists('movedo_grve_print_post_loop_categories') ) {
...
if ( !function_exists('movedo_grve_print_post_image') ) {
...
if ( !function_exists('movedo_grve_print_post_bg_image') ) {
 ...
 */
if ( !function_exists('movedo_grve_print_post_author') ) {
 ...
 */
if ( !function_exists('movedo_grve_print_post_audio') ) {
 ...
 */
if ( !function_exists('movedo_grve_print_post_video') ) {
...
if ( !function_exists('movedo_grve_get_related_posts') ) {
	function movedo_grve_get_related_posts( $max_posts = 3) {
		...
		$post_related_mode = movedo_grve_option( 'post_related_mode', 'tag' );
 ...
 */
if ( !function_exists('movedo_grve_print_related_posts') ) {
 ...
 */
if ( !function_exists('movedo_grve_likes_callback') ) {
	function movedo_grve_likes_callback( $post_id ) {

		check_ajax_referer( 'movedo-grve-likes', '_grve_nonce' );
...
if ( !function_exists('movedo_grve_likes') ) {
...
if ( !function_exists('movedo_grve_likes_text') ) {
...
if ( !function_exists( 'movedo_grve_print_post_structured_data' ) ) {
	function movedo_grve_print_post_structured_data( $args = array() ) {
		...
		$author_logo_url = movedo_grve_option( 'logo', '', 'url' );
