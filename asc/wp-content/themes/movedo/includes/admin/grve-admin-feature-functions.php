...
function movedo_grve_get_replaced_image() {
	...
	check_ajax_referer( 'movedo-grve-get-replaced-image', '_grve_nonce' );
...
function movedo_grve_get_admin_feature_slider_media() {
	...
	check_ajax_referer( 'movedo-grve-get-feature-slider-media', '_grve_nonce' );
...
function movedo_grve_get_map_point() {
	...
	check_ajax_referer( 'movedo-grve-get-map-point', '_grve_nonce' );
...
function movedo_grve_print_admin_feature_map_point( $map_item, $mode = '' ) {
	...
	if( "new" == $mode ) {
		...
		$movedo_grve_closed_class = "grve-item-new grve-toggle-new";
	}
?>
	<div class="grve-map-item postbox <?php echo esc_attr( $movedo_grve_closed_class ); ?>">
		...
		<h3 class="grve-title grve-item-title">
...
?>
	...
	<div class="grve-slider-item postbox <?php echo esc_attr( $movedo_grve_closed_class ); ?>">
		...
		<span class="grve-button-spacer">&nbsp;</span>
		<span class="grve-modal-spinner"></span>
		<h3 class="grve-title grve-item-title grve-movable">
...
function movedo_grve_print_admin_feature_item_video_options( $item ) {
	...
	movedo_grve_print_admin_option(
		array(
			...
			'value' => $video_muted,
			'label' => array(
				"title" => esc_html__( 'Muted', 'movedo' ),
				"info" => esc_html__( 'Note: Due to new browser/device restrictions, videos with sound are no longer allowed to autoplay in Chrome, Safari and mobile devices. In these cases videos will be automatically muted.', 'movedo' ),
			),
		)
	);
	movedo_grve_print_admin_option(
	...
	movedo_grve_print_admin_option(
		array(
			...
			'label' => array(
				...
				"desc" => esc_html__( 'e.g: https://www.youtube.com/watch?v=fB7TMC6LaJQ', 'movedo' ),
			),
			'width' => 'fullwidth',
		)
	);
					...
					<div class="grve-fields-wrapper">
						<div class="grve-label">
							<label for="grve-page-feature-element">
								...
								<span class="grve-description"><?php esc_html_e( 'Type the specific post ids you want to include separated by comma ( , ) and click Insert Posts to Slider.', 'movedo' ); ?></span>
							</label>
						</div>
						<div class="grve-field-items-wrapper">
							<div class="grve-field-item">
							...
							<div class="grve-field-item">
								<input id="grve-upload-feature-slider-post-selection" type="text" value="" />
							</div>
						</div>
					</div>
					<?php } ?>
...
function movedo_grve_admin_save_feature_section( $post_id ) {
	...
	if ( isset( $_POST['_movedo_grve_page_feature_element'] ) ) {
		...
		$feature_section['feature_settings'] = array (
			'element' => sanitize_text_field( $_POST['_movedo_grve_page_feature_element'] ),
			'size' => sanitize_text_field( $_POST['_movedo_grve_page_feature_size'] ),
			'height' => sanitize_text_field( $_POST['_movedo_grve_page_feature_height'] ),
			'min_height' => sanitize_text_field( $_POST['_movedo_grve_page_feature_min_height'] ),
			'header_position' => sanitize_text_field( $_POST['_movedo_grve_page_feature_header_position'] ),
			'bg_color' => sanitize_text_field( $_POST['_movedo_grve_page_feature_bg_color'] ),
			'bg_color_custom' => sanitize_text_field( $_POST['_movedo_grve_page_feature_bg_color_custom'] ),
			'bg_gradient_color_1' => sanitize_text_field( $_POST['_movedo_grve_page_feature_bg_gradient_color_1'] ),
			'bg_gradient_color_2' => sanitize_text_field( $_POST['_movedo_grve_page_feature_bg_gradient_color_2'] ),
			'bg_gradient_direction' => sanitize_text_field( $_POST['_movedo_grve_page_feature_bg_gradient_direction'] ),
			'separator_bottom' => sanitize_text_field( $_POST['_movedo_grve_page_feature_separator_bottom'] ),
			'separator_bottom_color' => sanitize_text_field( $_POST['_movedo_grve_page_feature_separator_bottom_color'] ),
			'separator_bottom_size' => sanitize_text_field( $_POST['_movedo_grve_page_feature_separator_bottom_size'] ),
		...
		if ( isset( $_POST['_movedo_grve_page_revslider'] ) ) {
			$feature_section['revslider_alias'] = sanitize_text_field( $_POST['_movedo_grve_page_revslider'] );
		}
		...
		if ( isset( $_POST['_movedo_grve_single_item_title'] ) ) {
			...
			$feature_section['single_item'] = array (
				...
				'title' => wp_filter_post_kses( $_POST['_movedo_grve_single_item_title'] ),
				'content_bg_color' => sanitize_text_field( $_POST['_movedo_grve_single_item_title_content_bg_color'] ),
				'content_bg_color_custom' => sanitize_text_field( $_POST['_movedo_grve_single_item_title_content_bg_color_custom'] ),
				'title_color' => sanitize_text_field( $_POST['_movedo_grve_single_item_title_color'] ),
				'title_color_custom' => sanitize_text_field( $_POST['_movedo_grve_single_item_title_color_custom'] ),
				'title_tag' => sanitize_text_field( $_POST['_movedo_grve_single_item_title_tag'] ),
				'caption' => wp_filter_post_kses( $_POST['_movedo_grve_single_item_caption'] ),
				'caption_color' => sanitize_text_field( $_POST['_movedo_grve_single_item_caption_color'] ),
				'caption_color_custom' => sanitize_text_field( $_POST['_movedo_grve_single_item_caption_color_custom'] ),
				'caption_tag' => sanitize_text_field( $_POST['_movedo_grve_single_item_caption_tag'] ),
				'subheading' => wp_filter_post_kses( $_POST['_movedo_grve_single_item_subheading'] ),
				'subheading_color' => sanitize_text_field( $_POST['_movedo_grve_single_item_subheading_color'] ),
				'subheading_color_custom' => sanitize_text_field( $_POST['_movedo_grve_single_item_subheading_color_custom'] ),
				'subheading_tag' => sanitize_text_field( $_POST['_movedo_grve_single_item_subheading_tag'] ),
				'subheading_family' => sanitize_text_field( $_POST['_movedo_grve_single_item_subheading_family'] ),
				'title_family' => sanitize_text_field( $_POST['_movedo_grve_single_item_title_family'] ),
				'caption_family' => sanitize_text_field( $_POST['_movedo_grve_single_item_caption_family'] ),
				'content_size' => sanitize_text_field( $_POST['_movedo_grve_single_item_content_size'] ),
				'content_align' => sanitize_text_field( $_POST['_movedo_grve_single_item_content_align'] ),
				'content_position' => sanitize_text_field( $_POST['_movedo_grve_single_item_content_position'] ),
				'content_animation' => sanitize_text_field( $_POST['_movedo_grve_single_item_content_animation'] ),
				'container_size' => sanitize_text_field( $_POST['_movedo_grve_single_item_container_size'] ),
				'content_image_id' => sanitize_text_field( $_POST['_movedo_grve_single_item_content_image_id'] ),
				'content_image_size' => sanitize_text_field( $_POST['_movedo_grve_single_item_content_image_size'] ),
				'content_image_max_height' => sanitize_text_field( $_POST['_movedo_grve_single_item_content_image_max_height'] ),
				'content_image_responsive_max_height' => sanitize_text_field( $_POST['_movedo_grve_single_item_content_image_responsive_max_height'] ),
				'pattern_overlay' => sanitize_text_field( $_POST['_movedo_grve_single_item_pattern_overlay'] ),
				'color_overlay' => sanitize_text_field( $_POST['_movedo_grve_single_item_color_overlay'] ),
				'color_overlay_custom' => sanitize_text_field( $_POST['_movedo_grve_single_item_color_overlay_custom'] ),
				'opacity_overlay' => sanitize_text_field( $_POST['_movedo_grve_single_item_opacity_overlay'] ),
				'gradient_overlay_custom_1' => sanitize_text_field( $_POST['_movedo_grve_single_item_gradient_overlay_custom_1'] ),
				'gradient_overlay_custom_1_opacity' => sanitize_text_field( $_POST['_movedo_grve_single_item_gradient_overlay_custom_1_opacity'] ),
				'gradient_overlay_custom_2' => sanitize_text_field( $_POST['_movedo_grve_single_item_gradient_overlay_custom_2'] ),
				'gradient_overlay_custom_2_opacity' => sanitize_text_field( $_POST['_movedo_grve_single_item_gradient_overlay_custom_2_opacity'] ),
				'gradient_overlay_direction' => sanitize_text_field( $_POST['_movedo_grve_single_item_gradient_overlay_direction'] ),
				'bg_image_id' => sanitize_text_field( $_POST['_movedo_grve_single_item_bg_image_id'] ),
				'bg_image_size' => sanitize_text_field( $_POST['_movedo_grve_single_item_bg_image_size'] ),
				'bg_position' => sanitize_text_field( $_POST['_movedo_grve_single_item_bg_position'] ),
				'bg_tablet_sm_position' => sanitize_text_field( $_POST['_movedo_grve_single_item_bg_tablet_sm_position'] ),
				'image_effect' => sanitize_text_field( $_POST['_movedo_grve_single_item_image_effect'] ),
				'video_webm' => sanitize_text_field( $_POST['_movedo_grve_single_item_video_webm'] ),
				'video_mp4' => sanitize_text_field( $_POST['_movedo_grve_single_item_video_mp4'] ),
				'video_ogv' => sanitize_text_field( $_POST['_movedo_grve_single_item_video_ogv'] ),
				'video_poster' => sanitize_text_field( $_POST['_movedo_grve_single_item_video_poster'] ),
				'video_device' => sanitize_text_field( $_POST['_movedo_grve_single_item_video_device'] ),
				'video_loop' => sanitize_text_field( $_POST['_movedo_grve_single_item_video_loop'] ),
				'video_muted' => sanitize_text_field( $_POST['_movedo_grve_single_item_video_muted'] ),
				'video_effect' => sanitize_text_field( $_POST['_movedo_grve_single_item_video_effect'] ),
				'video_url' => sanitize_text_field( $_POST['_movedo_grve_single_item_video_url'] ),
				'video_start' => sanitize_text_field( $_POST['_movedo_grve_single_item_video_start'] ),
				'video_end' => sanitize_text_field( $_POST['_movedo_grve_single_item_video_end'] ),
				'button' => array(
					'id' => sanitize_text_field( $_POST['_movedo_grve_single_item_button_id'] ),
					'text' => sanitize_text_field( $_POST['_movedo_grve_single_item_button_text'] ),
					'url' => sanitize_text_field( $_POST['_movedo_grve_single_item_button_url'] ),
					'target' => sanitize_text_field( $_POST['_movedo_grve_single_item_button_target'] ),
					'color' => sanitize_text_field( $_POST['_movedo_grve_single_item_button_color'] ),
					'hover_color' => sanitize_text_field( $_POST['_movedo_grve_single_item_button_hover_color'] ),
					'gradient_1_color' => sanitize_text_field( $_POST['_movedo_grve_single_item_button_gradient_1_color'] ),
					'gradient_2_color' => sanitize_text_field( $_POST['_movedo_grve_single_item_button_gradient_2_color'] ),
					'size' => sanitize_text_field( $_POST['_movedo_grve_single_item_button_size'] ),
					'shape' => sanitize_text_field( $_POST['_movedo_grve_single_item_button_shape'] ),
					'shadow' => sanitize_text_field( $_POST['_movedo_grve_single_item_button_shadow'] ),
					'type' => sanitize_text_field( $_POST['_movedo_grve_single_item_button_type'] ),
					'class' => sanitize_text_field( $_POST['_movedo_grve_single_item_button_class'] ),
				),
				'button2' => array(
					'id' => sanitize_text_field( $_POST['_movedo_grve_single_item_button2_id'] ),
					'text' => sanitize_text_field( $_POST['_movedo_grve_single_item_button2_text'] ),
					'url' => sanitize_text_field( $_POST['_movedo_grve_single_item_button2_url'] ),
					'target' => sanitize_text_field( $_POST['_movedo_grve_single_item_button2_target'] ),
					'color' => sanitize_text_field( $_POST['_movedo_grve_single_item_button2_color'] ),
					'hover_color' => sanitize_text_field( $_POST['_movedo_grve_single_item_button2_hover_color'] ),
					'gradient_1_color' => sanitize_text_field( $_POST['_movedo_grve_single_item_button2_gradient_1_color'] ),
					'gradient_2_color' => sanitize_text_field( $_POST['_movedo_grve_single_item_button2_gradient_2_color'] ),
					'size' => sanitize_text_field( $_POST['_movedo_grve_single_item_button2_size'] ),
					'shape' => sanitize_text_field( $_POST['_movedo_grve_single_item_button2_shape'] ),
					'shadow' => sanitize_text_field( $_POST['_movedo_grve_single_item_button2_shadow'] ),
					'type' => sanitize_text_field( $_POST['_movedo_grve_single_item_button2_type'] ),
					'class' => sanitize_text_field( $_POST['_movedo_grve_single_item_button2_class'] ),
				),
				'arrow_enabled' => sanitize_text_field( $_POST['_movedo_grve_single_item_arrow_enabled'] ),
				'arrow_color' => sanitize_text_field( $_POST['_movedo_grve_single_item_arrow_color'] ),
				'arrow_color_custom' => sanitize_text_field( $_POST['_movedo_grve_single_item_arrow_color_custom'] ),
				'el_class' => sanitize_text_field( $_POST['_movedo_grve_single_item_el_class'] ),
		...
		if ( isset( $_POST['_movedo_grve_slider_item_id'] ) ) {
			...
			for ( $i=0; $i < $num_of_images; $i++ ) {
				...
				$slide = array (
					'id' => sanitize_text_field( $_POST['_movedo_grve_slider_item_id'][ $i ] ),
					'type' => sanitize_text_field( $_POST['_movedo_grve_slider_item_type'][ $i ] ),
					'post_id' => sanitize_text_field( $_POST['_movedo_grve_slider_item_post_id'][ $i ] ),
					'bg_image_id' => sanitize_text_field( $_POST['_movedo_grve_slider_item_bg_image_id'][ $i ] ),
					'bg_image_size' => sanitize_text_field( $_POST['_movedo_grve_slider_item_bg_image_size'][ $i ] ),
					'bg_position' => sanitize_text_field( $_POST['_movedo_grve_slider_item_bg_position'][ $i ] ),
					'bg_tablet_sm_position' => sanitize_text_field( $_POST['_movedo_grve_slider_item_bg_tablet_sm_position'][ $i ] ),
					'header_style' => sanitize_text_field( $_POST['_movedo_grve_slider_item_header_style'][ $i ] ),
					'title' => wp_filter_post_kses( $_POST['_movedo_grve_slider_item_title'][ $i ] ),
					'content_bg_color' => sanitize_text_field( $_POST['_movedo_grve_slider_item_title_content_bg_color'][ $i ] ),
					'content_bg_color_custom' => sanitize_text_field( $_POST['_movedo_grve_slider_item_title_content_bg_color_custom'][ $i ] ),
					'title_color' => sanitize_text_field( $_POST['_movedo_grve_slider_item_title_color'][ $i ] ),
					'title_color_custom' => sanitize_text_field( $_POST['_movedo_grve_slider_item_title_color_custom'][ $i ] ),
					'title_tag' => sanitize_text_field( $_POST['_movedo_grve_slider_item_title_tag'][ $i ] ),
					'caption' => wp_filter_post_kses( $_POST['_movedo_grve_slider_item_caption'][ $i ] ),
					'caption_color' => sanitize_text_field( $_POST['_movedo_grve_slider_item_caption_color'][ $i ] ),
					'caption_color_custom' => sanitize_text_field( $_POST['_movedo_grve_slider_item_caption_color_custom'][ $i ] ),
					'caption_tag' => sanitize_text_field( $_POST['_movedo_grve_slider_item_caption_tag'][ $i ] ),
					'subheading' => wp_filter_post_kses( $_POST['_movedo_grve_slider_item_subheading'][ $i ] ),
					'subheading_color' => sanitize_text_field( $_POST['_movedo_grve_slider_item_subheading_color'][ $i ] ),
					'subheading_color_custom' => sanitize_text_field( $_POST['_movedo_grve_slider_item_subheading_color_custom'][ $i ] ),
					'subheading_tag' => sanitize_text_field( $_POST['_movedo_grve_slider_item_subheading_tag'][ $i ] ),
					'subheading_family' => sanitize_text_field( $_POST['_movedo_grve_slider_item_subheading_family'][ $i ] ),
					'title_family' => sanitize_text_field( $_POST['_movedo_grve_slider_item_title_family'][ $i ] ),
					'caption_family' => sanitize_text_field( $_POST['_movedo_grve_slider_item_caption_family'][ $i ] ),
					'content_size' => sanitize_text_field( $_POST['_movedo_grve_slider_item_content_size'][ $i ] ),
					'content_align' => sanitize_text_field( $_POST['_movedo_grve_slider_item_content_align'][ $i ] ),
					'content_position' => sanitize_text_field( $_POST['_movedo_grve_slider_item_content_position'][ $i ] ),
					'content_animation' => sanitize_text_field( $_POST['_movedo_grve_slider_item_content_animation'][ $i ] ),
					'container_size' => sanitize_text_field( $_POST['_movedo_grve_slider_item_container_size'][ $i ] ),
					'content_image_id' => sanitize_text_field( $_POST['_movedo_grve_slider_item_content_image_id'][ $i ] ),
					'content_image_size' => sanitize_text_field( $_POST['_movedo_grve_slider_item_content_image_size'][ $i ] ),
					'content_image_max_height' => sanitize_text_field( $_POST['_movedo_grve_slider_item_content_image_max_height'][ $i ] ),
					'content_image_responsive_max_height' => sanitize_text_field( $_POST['_movedo_grve_slider_item_content_image_responsive_max_height'][ $i ] ),
					'pattern_overlay' => sanitize_text_field( $_POST['_movedo_grve_slider_item_pattern_overlay'][ $i ] ),
					'color_overlay' => sanitize_text_field( $_POST['_movedo_grve_slider_item_color_overlay'][ $i ] ),
					'color_overlay_custom' => sanitize_text_field( $_POST['_movedo_grve_slider_item_color_overlay_custom'][ $i ] ),
					'opacity_overlay' => sanitize_text_field( $_POST['_movedo_grve_slider_item_opacity_overlay'][ $i ] ),
					'gradient_overlay_custom_1' => sanitize_text_field( $_POST['_movedo_grve_slider_item_gradient_overlay_custom_1'][ $i ] ),
					'gradient_overlay_custom_1_opacity' => sanitize_text_field( $_POST['_movedo_grve_slider_item_gradient_overlay_custom_1_opacity'][ $i ] ),
					'gradient_overlay_custom_2' => sanitize_text_field( $_POST['_movedo_grve_slider_item_gradient_overlay_custom_2'][ $i ] ),
					'gradient_overlay_custom_2_opacity' => sanitize_text_field( $_POST['_movedo_grve_slider_item_gradient_overlay_custom_2_opacity'][ $i ] ),
					'gradient_overlay_direction' => sanitize_text_field( $_POST['_movedo_grve_slider_item_gradient_overlay_direction'][ $i ] ),
					'button' => array(
						'id' => sanitize_text_field( $_POST['_movedo_grve_slider_item_button_id'][ $i ] ),
						'text' => sanitize_text_field( $_POST['_movedo_grve_slider_item_button_text'][ $i ] ),
						'url' => sanitize_text_field( $_POST['_movedo_grve_slider_item_button_url'][ $i ] ),
						'target' => sanitize_text_field( $_POST['_movedo_grve_slider_item_button_target'][ $i ] ),
						'color' => sanitize_text_field( $_POST['_movedo_grve_slider_item_button_color'][ $i ] ),
						'hover_color' => sanitize_text_field( $_POST['_movedo_grve_slider_item_button_hover_color'][ $i ] ),
						'gradient_1_color' => sanitize_text_field( $_POST['_movedo_grve_slider_item_button_gradient_1_color'][ $i ] ),
						'gradient_2_color' => sanitize_text_field( $_POST['_movedo_grve_slider_item_button_gradient_2_color'][ $i ] ),
						'size' => sanitize_text_field( $_POST['_movedo_grve_slider_item_button_size'][ $i ] ),
						'shape' => sanitize_text_field( $_POST['_movedo_grve_slider_item_button_shape'][ $i ] ),
						'shadow' => sanitize_text_field( $_POST['_movedo_grve_slider_item_button_shadow'][ $i ] ),
						'type' => sanitize_text_field( $_POST['_movedo_grve_slider_item_button_type'][ $i ] ),
						'class' => sanitize_text_field( $_POST['_movedo_grve_slider_item_button_class'][ $i ] ),
					),
					'button2' => array(
						'id' => sanitize_text_field( $_POST['_movedo_grve_slider_item_button2_id'][ $i ] ),
						'text' => sanitize_text_field( $_POST['_movedo_grve_slider_item_button2_text'][ $i ] ),
						'url' => sanitize_text_field( $_POST['_movedo_grve_slider_item_button2_url'][ $i ] ),
						'target' => sanitize_text_field( $_POST['_movedo_grve_slider_item_button2_target'][ $i ] ),
						'color' => sanitize_text_field( $_POST['_movedo_grve_slider_item_button2_color'][ $i ] ),
						'hover_color' => sanitize_text_field( $_POST['_movedo_grve_slider_item_button2_hover_color'][ $i ] ),
						'gradient_1_color' => sanitize_text_field( $_POST['_movedo_grve_slider_item_button2_gradient_1_color'][ $i ] ),
						'gradient_2_color' => sanitize_text_field( $_POST['_movedo_grve_slider_item_button2_gradient_2_color'][ $i ] ),
						'size' => sanitize_text_field( $_POST['_movedo_grve_slider_item_button2_size'][ $i ] ),
						'shape' => sanitize_text_field( $_POST['_movedo_grve_slider_item_button2_shape'][ $i ] ),
						'shadow' => sanitize_text_field( $_POST['_movedo_grve_slider_item_button2_shadow'][ $i ] ),
						'type' => sanitize_text_field( $_POST['_movedo_grve_slider_item_button2_type'][ $i ] ),
						'class' => sanitize_text_field( $_POST['_movedo_grve_slider_item_button2_class'][ $i ] ),
					),
					'arrow_enabled' => sanitize_text_field( $_POST['_movedo_grve_slider_item_arrow_enabled'][ $i ] ),
					'arrow_color' => sanitize_text_field( $_POST['_movedo_grve_slider_item_arrow_color'][ $i ] ),
					'arrow_color_custom' => sanitize_text_field( $_POST['_movedo_grve_slider_item_arrow_color_custom'][ $i ] ),
					'el_class' => sanitize_text_field( $_POST['_movedo_grve_slider_item_el_class'][ $i ] ),
				);
		...
		if( !empty( $slider_items ) ) {
			...
			$feature_section['slider_settings'] = array (
				'slideshow_speed' => sanitize_text_field( $_POST['_movedo_grve_page_slider_settings_speed'] ),
				'direction_nav' => sanitize_text_field( $_POST['_movedo_grve_page_slider_settings_direction_nav'] ),
				'slider_pause' => sanitize_text_field( $_POST['_movedo_grve_page_slider_settings_pause'] ),
				'transition' => sanitize_text_field( $_POST['_movedo_grve_page_slider_settings_transition'] ),
				'slider_effect' => sanitize_text_field( $_POST['_movedo_grve_page_slider_settings_effect'] ),
				'pagination' => sanitize_text_field( $_POST['_movedo_grve_page_slider_settings_pagination'] ),
			);
		}
		...
		if ( isset( $_POST['_movedo_grve_map_item_point_id'] ) ) {
			...
			for ( $i=0; $i < $num_of_map_points; $i++ ) {
				...
				$this_point = array (
					'id' => sanitize_text_field( $_POST['_movedo_grve_map_item_point_id'][ $i ] ),
					'lat' => sanitize_text_field( $_POST['_movedo_grve_map_item_point_lat'][ $i ] ),
					'lng' => sanitize_text_field( $_POST['_movedo_grve_map_item_point_lng'][ $i ] ),
					'marker' => sanitize_text_field( $_POST['_movedo_grve_map_item_point_marker'][ $i ] ),
					'title' => sanitize_text_field( $_POST['_movedo_grve_map_item_point_title'][ $i ] ),
					'info_text' => wp_filter_post_kses( $_POST['_movedo_grve_map_item_point_infotext'][ $i ] ),
					'info_text_open' => sanitize_text_field( $_POST['_movedo_grve_map_item_point_infotext_open'][ $i ] ),
					'button_text' => sanitize_text_field( $_POST['_movedo_grve_map_item_point_button_text'][ $i ] ),
					'button_url' => sanitize_text_field( $_POST['_movedo_grve_map_item_point_button_url'][ $i ] ),
					'button_target' => sanitize_text_field( $_POST['_movedo_grve_map_item_point_button_target'][ $i ] ),
					'button_class' => sanitize_text_field( $_POST['_movedo_grve_map_item_point_button_class'][ $i ] ),
				);
		...
		if( !empty( $map_items ) ) {
			...
			$feature_section['map_settings'] = array (
				'zoom' => sanitize_text_field( $_POST['_movedo_grve_page_feature_map_zoom'] ),
				'marker' => sanitize_text_field( $_POST['_movedo_grve_page_feature_map_marker'] ),
				'marker_type' => sanitize_text_field( $_POST['_movedo_grve_page_feature_map_marker_type'] ),
				'marker_bg_color' => sanitize_text_field( $_POST['_movedo_grve_page_feature_map_marker_bg_color'] ),
				'disable_style' => sanitize_text_field( $_POST['_movedo_grve_page_feature_map_disable_style'] ),
			);
