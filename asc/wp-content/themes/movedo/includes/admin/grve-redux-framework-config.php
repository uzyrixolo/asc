	...
	class Movedo_GRVE_Redux_Framework_config {
		...
		public function setSections( $opt_name ) {
			...
			$movedo_grve_header_menu_options = array(
				...
				'login' => esc_html__( 'Login (Movedo Extension Required)', 'movedo' ),
			...
			$movedo_gmap_api_key_link = '<a href="//developers.google.com/maps/documentation/javascript/get-api-key" target="_blank" rel="noopener noreferrer">' . esc_html__( 'Generate Google Map API Key', 'movedo' ) . '</a>';
			$movedo_gmap_style_link = '<a href="//mapstyle.withgoogle.com/" target="_blank" rel="noopener noreferrer">' . esc_html__( 'Styling Wizard Google Maps API.', 'movedo' ) . '</a>';


			$movedo_is_google = apply_filters( 'movedo_grve_gfonts_visibility', true );
			...
			$this->sections[] = array(
				...
				'fields' => array(
					...
					array(
						'id' => 'top_bar_left_text', //TRANSLATION STRING
						'type' => 'text',
					...
					array(
						'id' => 'top_bar_left_form', //TRANSLATION STRING
						'type' => 'select',
					...
					array(
						'id' => 'top_bar_left_gravity_form', //TRANSLATION STRING
						'type' => 'select',
						'title' => esc_html__( 'Left Area Form', 'movedo' ),
					...
					array(
						'id' => 'top_bar_right_text', //TRANSLATION STRING
						'type' => 'text',
					...
					array(
						'id' => 'top_bar_right_form', //TRANSLATION STRING
						'type' => 'select',
					...
					array(
						'id' => 'top_bar_right_gravity_form', //TRANSLATION STRING
						'type' => 'select',
						'title' => esc_html__( 'Right Area Form', 'movedo' ),
						'subtitle' => esc_html__( 'Select the form for your Gravity Form.', 'movedo' ),
						'options' => $movedo_grve_gravity_options,
			...
			$this->sections[] = array(
				...
				'fields' => array(
					...
					array(
						'id' => 'header_menu_form', //TRANSLATION STRING
						'type' => 'select',
					...
					array(
						'id' => 'header_menu_gravity_form', //TRANSLATION STRING
						'type' => 'select',
						'title' => esc_html__( 'Menu Form', 'movedo' ),
						'subtitle' => esc_html__( 'Select the form for your Gravity Form.', 'movedo' ),
						'options' => $movedo_grve_gravity_options,
					...
					array(
						'id' => 'header_menu_text_element', //TRANSLATION STRING
						'type' => 'editor',
						'args' => $editor_args,
			...
			$this->sections[] = array(
				...
				'fields' => array(
					...
					array(
						'id' => 'menu_responsive_toggle_text', //TRANSLATION STRING
						'type' => 'text',
					...
					array(
						'id' => 'menu_responsive_text', //TRANSLATION STRING
						'type' => 'editor',
						'args' => $editor_args,
			...
			$this->sections[] = array(
				...
				'fields' => array(
					array(
						'id' => 'header_safebutton_area', //TRANSLATION STRING
						'type' => 'select',
			...
			$this->sections[] = array(
				...
				'fields' => array(
					...
					array(
						'id' => 'bottom_bar_area', //TRANSLATION STRING
						'type' => 'select',
					...
					array(
						'id' => 'footer_second_copyright_text', //TRANSLATION STRING
						'type' => 'editor',
						'args' => $editor_args,
				...
				'fields' => array(
					...
					array(
						...
						'options' => array(
							...
							'custom' => esc_html__( 'Custom Title / Description', 'movedo' ),
							'none' => esc_html__( 'None', 'movedo' ),
						),
						'default' => 'sitetitle',
						'validate' => 'not_empty',
					...
					array(
						'id' => 'blog_custom_title', //TRANSLATION STRING
						'type' => 'text',
						'default' => '',
						'title' => esc_html__( 'Custom Title', 'movedo' ),
						'subtitle' => esc_html__( 'Enter blog custom title.', 'movedo' ),
						'required' => array( 'blog_title', 'equals', 'custom' ),
					),
					array(
						'id' => 'blog_custom_description', //TRANSLATION STRING
						'type' => 'text',
						'default' => '',
						'title' => esc_html__( 'Custom Description', 'movedo' ),
						'subtitle' => esc_html__( 'Enter blog custom description.', 'movedo' ),
						'required' => array( 'blog_title', 'equals', 'custom' ),
					),
					array(
			...
			$this->sections[] = array(
				...
				'fields' => array(
					...
					array(
						'id' => 'post_author_info_link_text', //TRANSLATION STRING
						'type' => 'text',
					...
					array(
						'id' => 'post_related_title_first', //TRANSLATION STRING
						'type' => 'text',
					...
					array(
						'id' => 'post_related_title_second', //TRANSLATION STRING
						'type' => 'text',
			...
			$this->sections[] = array(
				...
				'fields' => array(
					array(
						...
						'compiler' => true,
						'title' => esc_html__( 'Page Layout', 'movedo' ),
						'subtitle' => esc_html__( 'Select the layout for the search page. Choose among Full Width, Left Sidebar or Right Sidebar.', 'movedo' ),
						'options' => $movedo_grve_layout_selection,
						'default' => 'none',
					),
					array(
						...
						'type' => 'select',
						'title' => esc_html__( 'Page Sidebar', 'movedo' ),
						'subtitle' => esc_html__( 'Select the default sidebar for the search page in case you do not use full width layout.', 'movedo' ),
						'data' => 'sidebar',
						'default' => 'grve-default-sidebar',
					),
					array(
					...
					array(
						...
						'type' => 'switch',
						'title' => esc_html__( 'Breadcrumbs', 'movedo' ),
						'subtitle'=> esc_html__( 'Enable or Disable the Breadcrumbs for Search Page.', 'movedo' ),
						"default" => '0',
						'on' => esc_html__( 'On', 'movedo' ),
						'off' => esc_html__( 'Off', 'movedo' ),
					),
					...
					array(
						'id' => 'search_modal_text', //TRANSLATION STRING
						'type' => 'text',
					...
					array(
						'id' => 'search_modal_button_text', //TRANSLATION STRING
						'type' => 'text',
					...
					array(
						'id' => 'search_page_not_found_text', //TRANSLATION STRING
						'type' => 'editor',
						'args' => $editor_args,
			...
			$this->sections[] = array(
				...
				'fields' => array(
					...
					array(
						'id' => 'portfolio_details_text', //TRANSLATION STRING
						'type' => 'text',
					...
					array(
						'id' => 'portfolio_details_link_text', //TRANSLATION STRING
						'type' => 'text',
					...
					array(
						...
						'options' => array(
							'layout-1' => esc_html__( 'Bottom Navigation & Classic Recent', 'movedo' ),
							'layout-2' => esc_html__( 'Bottom Navigation & Recent Combo', 'movedo' ),
							'layout-3' => esc_html__( 'Floating Navigation & Classic Recent', 'movedo' ),
						),
						'default' => 'layout-1',
					),
					array(
					...
					array(
						'id' => 'portfolio_recent_title', //TRANSLATION STRING
						'type' => 'text',
					...
					array(
						'id' => 'portfolio_backlink_id', //TRANSLATION STRING
						'type' => 'select',
			...
			$this->sections[] = array(
				...
				'fields' => array(
					...
					array(
						...
						'type' => 'select',
						'title' => esc_html__( 'Loop Landscape Columns', 'movedo' ),
						'subtitle' => esc_html__( 'Select responsive column on tablet devices, landscape orientation.', 'movedo' ),
						'options' => array(
							'2' => '2',
							'3' => '3',
					...
					array(
						...
						'type' => 'select',
						'title' => esc_html__( 'Loop Tablet Portrait Columns', 'movedo' ),
						'subtitle' => esc_html__( 'Select responsive column on tablet devices, portrait orientation.', 'movedo' ),
						'options' => array(
							'2' => '2',
							'3' => '3',
					...
					array(
						...
						'type' => 'select',
						'title' => esc_html__( 'Loop Mobile Columns', 'movedo' ),
						'subtitle' => esc_html__( 'Select responsive column on mobile devices.', 'movedo' ),
						'options' => array(
							'1' => '1',
							'2' => '2',
					...
					array(
						...
						'type' => 'info',
						'class' => 'grve-redux-sub-info',
						'title' => esc_html__( 'Shop Extras', 'movedo' ),
						'subtitle'=> esc_html__( 'Set the style for additional shop settings.', 'movedo' ),
					),
					array(
						'id'=>'product_woo_quantity_buttons',
						'type' => 'switch',
						'title' => esc_html__( 'Product Quantity Buttons', 'movedo' ),
						'subtitle'=> esc_html__( 'Enable or Disable -/+ quantity buttons.', 'movedo' ),
						"default" => '1',
					),
				)
			);
			...
			$this->sections[] = array(
				...
				'fields' => array(
					...
					array(
						...
						'type' => 'select',
						'title' => esc_html__( 'Product Image / Thumbnails Style', 'movedo' ),
						'subtitle'=> esc_html__( 'Select the style for the single product image and thumbnails. Note: some external plugins might not be compatible with Theme style.', 'movedo' ),
						'options' => array(
							'theme' => esc_html__( 'Theme Style', 'movedo' ),
							'woo' => esc_html__( 'Default WooCommerce Style', 'movedo' ),
						),
						'default' => 'theme',
					),
					array(
					...
					array(
						...
						'type' => 'switch',
						'title' => esc_html__( 'Zoom Effect', 'movedo' ),
						'subtitle'=> esc_html__( 'Enable or Disable image zoom effect.', 'movedo' ),
						"default" => '1',
						'on' => esc_html__( 'On', 'movedo' ),
						'off' => esc_html__( 'Off', 'movedo' ),
					...
					array(
						...
						'type' => 'switch',
						'title' => esc_html__( 'Gallery Lightbox', 'movedo' ),
						'subtitle'=> esc_html__( 'Enable or Disable gallery lightbox.', 'movedo' ),
						"default" => '1',
						'on' => esc_html__( 'On', 'movedo' ),
						'off' => esc_html__( 'Off', 'movedo' ),
						'required' => array( 'product_image_thumb_style', 'equals', 'woo' ),
					...
					array(
						...
						'type' => 'switch',
						'title' => esc_html__( 'Gallery Slider', 'movedo' ),
						'subtitle'=> esc_html__( 'Enable or Disable gallery slider.', 'movedo' ),
						"default" => '1',
						'on' => esc_html__( 'On', 'movedo' ),
						'off' => esc_html__( 'Off', 'movedo' ),
						'required' => array( 'product_image_thumb_style', 'equals', 'woo' ),
					...
					array(
						...
						'type' => 'switch',
						'title' => esc_html__( 'Product Image Middle Content', 'movedo' ),
						'subtitle'=> esc_html__( 'Enable/Disable middle content for product image/thumbs and product summary.', 'movedo' ),
						'default' => 1,
						'on' => esc_html__( 'On', 'movedo' ),
						'off' => esc_html__( 'Off', 'movedo' ),
						'required' => array( 'product_image_thumb_style', 'equals', 'theme' ),
			...
			$this->sections[] = array(
				'title' => esc_html__( 'Product Search Settings', 'movedo' ),
				'id' => 'grve_redux_section_search_product_settings',
				'header' => '',
				'desc' => esc_html__( 'Define your preferences for the Product Search.', 'movedo' ),
				'submenu' => true,
				'icon' => 'el-icon-shopping-cart',
				'icon_class' => '',
				'customizer' => false,
				...
				'fields' => array(
					array(
						...
						'type' => 'image_select',
						'compiler' => true,
						'title' => esc_html__( 'Product Search Layout', 'movedo' ),
						'subtitle' => esc_html__( 'Select the layout for the product search. Choose among Full Width, Left Sidebar or Right Sidebar.', 'movedo' ),
						'options' => $movedo_grve_layout_selection,
						'default' => 'none',
					),
					array(
						...
						'type' => 'select',
						'title' => esc_html__( 'Product Search Sidebar', 'movedo' ),
						'subtitle' => esc_html__( 'Select the default sidebar for the pages in case you do not use full width layout.', 'movedo' ),
						'data' => 'sidebar',
						'default' => 'grve-default-sidebar',
					),
					array(
						...
						'type' => 'select',
						'title' => esc_html__( 'Product Search Fixed Sidebar', 'movedo' ),
						'subtitle'=> esc_html__( 'Select if you want a fixed sidebar.', 'movedo' ),
						'options' => $movedo_grve_enable_selection,
						'default' => 'no',
					),
			...
			$this->sections[] = array(
				'icon' => 'fas fa-brush',
				'icon_class' => '',
				'title' => esc_html__( 'Colors - Privacy / Cookies', 'movedo' ),
				'id' => 'grve_redux_section_colors_privacy_consent_bar',
				'desc' => esc_html__( 'Set your color preferences for Privacy / Cookies feature.', 'movedo' ),
				'submenu' => false,
				'panel' => false,
				'grve_colors' => true,
				'subsection' => false,
				'fields' => array(
					array(
						...
						'type' => 'color',
						'title' => esc_html__( 'Background Color', 'movedo' ),
						'subtitle' => esc_html__( 'Select the background color of Privacy Consent Info Bar.', 'movedo' ),
						'default'  => '#000000',
						'transparent' => false,
					),
					array(
					...
					array(
						...
						'type' => 'color',
						'title' => esc_html__( 'Text Color', 'movedo' ),
						'subtitle' => esc_html__( 'Select the color of Privacy Consent Info Bar Text.', 'movedo' ),
						'default'  => '#ffffff',
						'transparent' => false,
					),
					array(
						...
						'type' => 'color',
						'title' => esc_html__( 'Button Text Color', 'movedo' ),
						'subtitle' => esc_html__( 'Select the color of Privacy Consent Info Bar Button Text.', 'movedo' ),
						'default'  => '#ffffff',
						'transparent' => false,
					),
					array(
						...
						'type' => 'color',
						'title' => esc_html__( 'Button Background Color', 'movedo' ),
						'subtitle' => esc_html__( 'Select the background color of Privacy Consent Info Bar Button.', 'movedo' ),
						'default'  => '#2bc137',
						'transparent' => false,
					),
					array(
						...
						'type' => 'color',
						'title' => esc_html__( 'Button Background Hover Color', 'movedo' ),
						'subtitle' => esc_html__( 'Select the background hover color of Privacy Consent Info Bar Button.', 'movedo' ),
						'default'  => '#17a523',
						'transparent' => false,
					),
					array(
						...
						'type' => 'color',
						'title' => esc_html__( 'Modal Button Text Color', 'movedo' ),
						'subtitle' => esc_html__( 'Select the color of Modal Button Text.', 'movedo' ),
						'default'  => '#ffffff',
						'transparent' => false,
					),
					array(
						...
						'type' => 'color',
						'title' => esc_html__( 'Modal Button Background Color', 'movedo' ),
						'subtitle' => esc_html__( 'Select the background color of Modal Button.', 'movedo' ),
						'default'  => '#2bc137',
						'transparent' => false,
					),
					array(
						...
						'type' => 'color',
						'title' => esc_html__( 'Modal Button Background Hover Color', 'movedo' ),
						'subtitle' => esc_html__( 'Select the background hover color of Modal Button.', 'movedo' ),
						'default'  => '#17a523',
						'transparent' => false,
					),
				)
			...
			$this->sections[] = array(
				...
				'fields' => array(
					array(
						'id' => 'social_rel_follow',
						'type' => 'checkbox',
						'title' => esc_html__( 'Social rel nofollow', 'movedo' ),
						'subtitle'=> esc_html__( 'If selected, rel nofollow attribute with be added in all social links.', 'movedo' ),
						'default' => 0,
					),
					array(
						'id' => 'social_options',
			...
			$this->sections[] = array(
				...
				'fields' => array(
					array(
						'id'=>'map_api_mode',
						'type' => 'button_set',
						'title' => esc_html__( 'Map API', 'movedo' ),
						'subtitle'=> esc_html__( 'Select the map API', 'movedo' ),
						'options' => array(
							'google-maps' => esc_html__( 'Google Maps', 'movedo' ),
							'openstreetmap' => esc_html__( 'OpenStreetMap', 'movedo' ),
						),
						'default' => 'google-maps',
					),
					array(
						'id'=>'map_tile_url',
						'type' => 'text',
						'title' => esc_html__( 'Tile Layer URL', 'movedo' ),
						'subtitle' => esc_html__( 'Define the Tile Layer. Used to load and display tile layers on the map.', 'movedo' ),
						'desc' => sprintf( '%1$s: <a href="//wiki.openstreetmap.org/wiki/Tile_servers" target="_blank"> %2$s </a>', esc_html__('See more tile servers', 'movedo'), esc_html__('here', 'movedo') ),
					...
					array(
						...
						'type' => 'text',
						'title' => esc_html__( 'Tile Layer Subdomains', 'movedo' ),
						'subtitle'=> esc_html__( 'Define the Tile Layer subdomains.', 'movedo' ),
						"default" => "abc",
						'required' => array( 'map_api_mode', 'equals', 'openstreetmap' ),
					),
					array(
						...
						'type' => 'text',
						'title' => esc_html__( 'Tile Layer Attribution', 'movedo' ),
						'subtitle' => esc_html__( 'Enter the Tile Layer attribution', 'movedo' ),
					...
					array(
						...
						'options' => array(
							'0' => esc_html__( 'No', 'movedo' ),
							'1' => esc_html__( 'Custom', 'movedo' ),
							'2' => esc_html__( 'Custom Code', 'movedo' ),
						),
						'default' => '0',
						'required' => array( 'map_api_mode', 'equals', 'google-maps' ),
					),
					array(
						'id' => 'gmap_custom_code',
						'type' => 'textarea',
						'title' => esc_html__( 'Custom Code', 'movedo' ),
						'subtitle' => esc_html__( 'Copy and paste the JSON here.', 'movedo' ) . $movedo_gmap_style_link,
						'default' => '',
						'rows' => '30',
					...
					array(
						...
						'type' => 'switch',
						'title' => esc_html__( 'Enable Map Type Control', 'movedo' ),
						'subtitle'=> esc_html__( 'Select if you want to enable map type control for your map.', 'movedo' ),
						'default' => 0,
						'required' => array( 'map_api_mode', 'equals', 'google-maps' ),
					),
					array(
						...
						'type' => 'select',
						'title' => esc_html__( 'Gesture Handling', 'movedo' ),
						'subtitle'=> esc_html__( 'Control how the API handles gestures on the map. For mobile web in particular, users may swipe the touchscreen, intending to scroll the page, but change the scale of the map instead.', 'movedo' ),
						'options' => array(
							'auto' => esc_html__( 'Auto', 'movedo' ),
							'greedy' => esc_html__( 'Greedy', 'movedo' ),
							'cooperative' => esc_html__( 'Cooperative', 'movedo' ),
							'none' => esc_html__( 'None', 'movedo' ),
						),
						'default' => 'auto',
						'required' => array( 'map_api_mode', 'equals', 'google-maps' ),
			...
			$this->sections[] = array(
				...
				'fields' => array(
					...
					array(
						'id' => 'page_404_content', //TRANSLATION STRING
						'type' => 'editor',
						'args' => $editor_args,
			...
			$this->sections[] = array(
				...
				'fields' => array(
					...
					array(
						'id'=>'logo_custom_link_url', //TRANSLATION STRING
						'type' => 'text',
					...
					array(
						'id'=>'popup_spinner',
						'type' => 'switch',
						'title' => esc_html__( 'Spinner for lightbox popups', 'movedo' ),
						'subtitle'=> esc_html__( 'Toggle spinner for lightbox popups on or off.', 'movedo' ),
						"default" => '1',
						'on' => esc_html__('On', 'movedo' ),
						'off' => esc_html__('Off', 'movedo' ),
					),
					array(
						'id'=>'popup_open_speed',
						'type' => 'select',
						'title' => esc_html__( 'Speed for lightbox popups', 'movedo' ),
						'subtitle' => esc_html__( 'Select the open speed of the popups.', 'movedo' ),
						'options' => array(
							'slow' => esc_html__( 'Slow', 'movedo' ),
							'normal' => esc_html__( 'Normal', 'movedo' ),
							'fast' => esc_html__( 'Fast', 'movedo' ),
						),
						'default' => 'slow',
						'validate' => 'not_empty',
					),
			...
			$this->sections[] = array(
				...
				'fields' => array(
					...
					array(
						'id'=>'login_custom_link_url', //TRANSLATION STRING
						'type' => 'text',
					...
					array(
						'id'=>'login_redirect_url', //TRANSLATION STRING
						'type' => 'text',
			...
			$this->sections[] = array(
				...
				'fields' => array(
					...
					array(
						'id'=>'meta_twitter',
						'type' => 'switch',
						'title' => esc_html__( 'Twitter (X) Card Meta', 'movedo' ),
						'subtitle'=> esc_html__( 'Generate meta tags for Twitter (X)', 'movedo' ),
						"default" => '0',
						'on' => esc_html__( 'On', 'movedo' ),
						'off' => esc_html__( 'Off', 'movedo' ),
					),
			...
			$this->sections[] = array(
				'icon' => 'el-icon-lock',
				'icon_class' => '',
				'title' => esc_html__( 'Privacy / Cookies', 'movedo' ),
				'desc' => esc_html__( 'The following shortcodes will allow your users to change certain behavior of your website regarding privacy.', 'movedo' ) . '<br>' .
					'<ul>' .
					'<li><strong>movedo_privacy_required</strong> - ' . esc_html__( 'displays a required content for your site e.g: Cloudlflare, CDN etc.', 'movedo' ) . '</li>' .
					'<li><strong>movedo_privacy_custom</strong> - ' . esc_html__( 'allows a user to enable/disable custom content', 'movedo' ) . '</li>' .
					'<li><strong>movedo_privacy_gtracking</strong> - ' . esc_html__( 'allows a user to enable/disable Google Analytics tracking code in the user\'s browser', 'movedo' ) . '</li>' .
					'<li><strong>movedo_privacy_gfonts</strong> - ' . esc_html__( 'allows a user to enable/disable the use of Google Fonts in the user\'s browser', 'movedo' ) . '</li>' .
					'<li><strong>movedo_privacy_gmaps</strong> - ' . esc_html__( 'allows a user to enable/disable the use of Google Maps in the user\'s browser', 'movedo' ) . '</li>' .
					'<li><strong>movedo_privacy_video_embeds</strong> - ' . esc_html__( 'allows a user to enable/disable video embeds in the user\'s browser', 'movedo' ) . '</li>' .
					'<li><strong>movedo_privacy_policy_page_link</strong> - ' . esc_html__( 'displays a link to the privacy policy page set from the WordPress admin panel', 'movedo' ) . '</li>' .
					'<li><strong>movedo_privacy_preferences_link</strong> - ' . esc_html__( 'displays a link to the privacy preferences as defined in the Privacy Consent Info Bar', 'movedo' ) . '</li>' .
					'</ul>' .
					esc_html__( 'You can use any of them in your privacy policy or in any text area that allows shortcodes.', 'movedo' ) . '<br><br>' .
					'<strong>[movedo_privacy_required value="required"]For performance and security reasons we use Cloudflare[/movedo_privacy_required]</strong><br>' .
					'<strong>[movedo_privacy_custom id="custom-id"]Click to enable/disable custom content.[/movedo_privacy_custom]</strong><br>' .

					'<strong>[movedo_privacy_gtracking]Click to enable/disable Google Analytics tracking code.[/movedo_privacy_gtracking]</strong><br>' .
					'<strong>[movedo_privacy_gfonts]Click to enable/disable Google Fonts.[/movedo_privacy_gfonts]</strong><br>' .
					'<strong>[movedo_privacy_gmaps]Click to enable/disable Google Maps.[/movedo_privacy_gmaps]</strong><br>' .
					'<strong>[movedo_privacy_video_embeds]Click to enable/disable video embeds.[/movedo_privacy_video_embeds]</strong><br>' .
					'<strong>[movedo_privacy_policy_page_link]</strong><br>' .
					'<strong>[movedo_privacy_preferences_link]</strong><br><br>' .
					esc_html__( 'Note: To change the default text add your text inside the shortcode tags [shortcode]Your text[/shortcode]', 'movedo' ),
				...
				'fields' => array(
					array(
						...
						'type' => 'info',
						'class' => 'grve-redux-sub-info',
						'title' => esc_html__( 'Privacy Content Blocking Settings', 'movedo' ),
						'subtitle'=> esc_html__( 'Configure the privacy content blocking settings.', 'movedo' ) . '<br>' . esc_html__( 'Note: The usage of the Blocking content feature is not recommended if you have added caching plugins or page rules to cache static HTML content (aggressive cache). If you use this feature you might need to disable such type of caching.', 'movedo' ),
					),
					array(
						'id' => 'privacy_content_blocking_enabled',
						'type' => 'switch',
						'title' => esc_html__( 'Privacy Content Blocking', 'movedo' ),
						'subtitle'=> esc_html__( 'Select if you want to enable/disable privacy content blocking.', 'movedo' ) .'<br><br>' . esc_html__( 'Note: if you disable content blocking certain privacy shortcodes will be automatically disabled.', 'movedo' ),
						'default' => 1,
					),
					array(
						'id'      => 'privacy_initial_state',
						'type'    => 'checkbox',
						'title'   => esc_html__( 'Privacy Initial Blocking State', 'movedo' ),
						'subtitle'    => esc_html__( 'Check if you want to block the content when the page loads.', 'movedo' ),
						'options'  => array(
							'gtracking' => esc_html__( "Google Tracking", "movedo" ),
							'gfonts' => esc_html__( "Google Fonts", "movedo" ),
							'gmaps' => esc_html__( "Google Maps", "movedo" ),
							'video-embeds' => esc_html__( "Embed Videos", "movedo" ),
						),
						'default' => array(
							'gtracking' => '0',
							'gfonts' => '0',
  					...
  					array(
						...
						'type' => 'multi_text',
						'title' => esc_html__('Privacy Custom Blocking Content Ids', 'movedo'),
						'subtitle' => esc_html__('Enter the ids for your custom blocking content. e.g: custom-id', 'movedo'),
						'required' => array( 'privacy_content_blocking_enabled', 'equals', '1' ),
					),
					array(
						...
						'type' => 'info',
						'class' => 'grve-redux-sub-info',
						'title' => esc_html__( 'Privacy Fallback Settings', 'movedo' ),
						'subtitle'=> esc_html__( 'Configure the privacy fallback info box.', 'movedo' ),
						'required' => array( 'privacy_content_blocking_enabled', 'equals', '1' ),
					),
					array(
						'id' => 'privacy_fallback_content', //TRANSLATION STRING
						'type' => 'textarea',
						'rows' => '2',
						'title' => esc_html__( 'Privacy Fallback Content', 'movedo' ),
						'subtitle' => esc_html__( 'Type the fallback text when the content is blocked.', 'movedo' ),
					...
					array(
						...
						'type'     => 'checkbox',
						'title'    => esc_html__('Display Privacy Preferences link', 'movedo'),
						'subtitle' => esc_html__('Select if you want to display the Privacy Preferences link ( if defined in the privacy consent bar ).', 'movedo'),
						'default'  => '1',
						'required' => array( 'privacy_content_blocking_enabled', 'equals', '1' ),
					),
					array(
						...
						'type'     => 'checkbox',
						'title'    => esc_html__('Display redirect link of the blocked content', 'movedo'),
						'subtitle' => esc_html__('Select if you want to display a redirect link of the blocked content ( blocked content will open in a new tab e.g: YouTube website ).', 'movedo'),
						'default'  => '1',
						'required' => array( 'privacy_content_blocking_enabled', 'equals', '1' ),
					),
					array(
						...
						'type' => 'info',
						'class' => 'grve-redux-sub-info',
						'title' => esc_html__( 'Privacy Consent Info Bar Settings', 'movedo' ),
						'subtitle'=> esc_html__( 'Configure the consent info bar.', 'movedo' ),
					),
					array(
						'id' => 'privacy_consent_bar_enabled',
						'type' => 'switch',
						'title' => esc_html__( 'Privacy Consent Info Bar', 'movedo' ),
						'subtitle'=> esc_html__( 'Select if you want to show a privacy consent info bar.', 'movedo' ),
						'default' => 0,
					),
					array(
						...
						'type' => 'select',
						'compiler' => true,
						'title' => esc_html__( 'Privacy Consent Info Bar Position', 'movedo' ),
						'subtitle' => esc_html__( 'Select the position for Privacy Consent Info Bar', 'movedo' ),
						'options' => array(
							'center' => esc_html__( 'Center', 'movedo' ),
							'left' => esc_html__( 'Left', 'movedo' ),
							'right' => esc_html__( 'Right', 'movedo' ),
					...
					array(
						'id' => 'privacy_consent_bar_content', //TRANSLATION STRING
						'type' => 'textarea',
						'rows' => '2',
						'title' => esc_html__( 'Privacy Info Bar Content', 'movedo' ),
						'subtitle' => esc_html__( 'Type the content of your consent info bar.', 'movedo' ),
					...
					array(
						'id'=>'privacy_agreement_button_label', //TRANSLATION STRING
						'type' => 'text',
						'title' => esc_html__( 'Privacy Agreement Button Label', 'movedo' ),
						'subtitle'=> esc_html__( 'Define the label for your privacy agreement button. Leave empty to remove.', 'movedo' ),
						'required' => array( 'privacy_consent_bar_enabled', 'equals', '1' ),
						"default" => 'I Agree',
					),
					array(
						'id'=>'privacy_preferences_button_label', //TRANSLATION STRING
						'type' => 'text',
						'title' => esc_html__( 'Privacy Preferences Button Label', 'movedo' ),
						'subtitle'=> esc_html__( 'Define the label for your privacy preferences button. Leave empty to remove.', 'movedo' ),
						'required' => array( 'privacy_consent_bar_enabled', 'equals', '1' ),
					...
					array(
						...
						'type' => 'select',
						'compiler' => true,
						'title' => esc_html__( 'Privacy Preferences Button Link Mode', 'movedo' ),
						'subtitle' => esc_html__( 'Select the preferences button link mode: modal, privacy policy page or custom url.', 'movedo' ),
						'options' => array(
							'modal' => esc_html__( 'Modal', 'movedo' ),
							'privacy_page' => esc_html__( 'Privacy Policy Page', 'movedo' ),
							'custom_url' => esc_html__( 'Custom URL', 'movedo' ),
						),
						'default' => 'modal',
						'validate' => 'not_empty',
						'required' => array( 'privacy_consent_bar_enabled', 'equals', '1' ),
					...
					array(
						'id'=>'privacy_preferences_link_url', //TRANSLATION STRING
						'type' => 'text',
						'title' => esc_html__( 'Privacy Preferences Custom Link URL', 'movedo' ),
						'subtitle'=> esc_html__( 'Define a custom URL link for your privacy preferences button.', 'movedo' ),
						'required' => array(
					...
					array(
						...
						'type' => 'select',
						'title' => esc_html__( 'Privacy Preferences Custom Link Target', 'movedo' ),
						'subtitle'=> esc_html__( 'Define the target for your custom url, same or new page.', 'movedo' ),
						'options' => array(
					...
					array(
						'id' => 'privacy_consent_modal_content', //TRANSLATION STRING
						'type' => 'editor',
						'args' => $editor_args,
						'title' => esc_html__( 'Privacy Modal Content', 'movedo' ),
						'subtitle' => esc_html__( 'Type the content of your modal consent dialog.', 'movedo' ),
						'default' => '<h5>Privacy Preferences</h5><p>When you visit our website, it may store information through your browser from specific services, usually in the form of cookies. Here you can change your Privacy preferences. It is worth noting that blocking some types of cookies may impact your experience on our website and the services we are able to offer.</p><div>[movedo_privacy_gtracking][movedo_privacy_gfonts][movedo_privacy_gmaps][movedo_privacy_video_embeds]</div>',
						'required' => array(
							array( 'privacy_consent_bar_enabled', 'equals', '1' ),
					...
					array(
						'id'=>'privacy_refresh_button_label', //TRANSLATION STRING
						'type' => 'text',
						'title' => esc_html__( 'Privacy Refresh Button Label', 'movedo' ),
						'subtitle'=> esc_html__( 'Define the label for your privacy refresh button. Leave empty to remove.', 'movedo' ),
						'required' => array(
							array( 'privacy_consent_bar_enabled', 'equals', '1' ),
							array( 'privacy_preferences_button_link', 'equals', 'modal' ),
						),
			...
			$this->sections[] = array(
				...
				'title' => esc_html__( 'Utilities', 'movedo' ),
			...
			$this->sections[] = array(
				'icon' => 'el-icon-cogs',
				'icon_class' => '',
				'title' => esc_html__( 'Theme Performance', 'movedo' ),
				...
				'fields' => array(
 					array(
						'id'=>'combine_js',
						'type' => 'select',
						'title' => esc_html__( 'Combine/Compress Theme Scripts', 'movedo' ),
						'subtitle'=> esc_html__( 'Select if you want to combine/compress theme scripts.', 'movedo' ),
						'options' => array(
							'1' => esc_html__( 'Partial merge/compression of theme javascript files', 'movedo' ),
							'0' => esc_html__( 'No merge/compression of theme javascript files', 'movedo' ),
						),
						"default" => '1',
					),
				)
			...
			$update_message = esc_html__( "Envato official solution is recommended for theme updates using the new Envato Market API.", 'movedo' ) .
		...
		public function setArguments( $opt_name ) {
			...
			$this->args = array(
				...
				'page_title' => esc_html__( 'Theme Options', 'movedo' ),
				...
				'menu_icon' => get_template_directory_uri() .'/includes/assets/images/adminmenu/theme.svg', // Specify a custom URL to an icon
				'last_tab' => '', // Force your panel to always open to a specific tab (by id)
				'page_icon' => 'icon-themes', // Icon displayed in the admin panel next to your menu_title
				'page_slug' => $opt_name, // Page slug used to denote the panel
