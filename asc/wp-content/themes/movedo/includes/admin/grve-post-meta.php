	...
	function movedo_grve_post_options_save_postdata( $post_id , $post ) {
		...
		if( empty( $media_slider_items ) ) {
			...
			if ( isset( $_POST['_movedo_grve_post_slider_settings_speed'] ) ) {
				$media_slider_speed = sanitize_text_field( $_POST['_movedo_grve_post_slider_settings_speed'] );
			}
			if ( isset( $_POST['_movedo_grve_post_slider_settings_direction_nav'] ) ) {
				$media_slider_direction_nav = sanitize_text_field( $_POST['_movedo_grve_post_slider_settings_direction_nav'] );
			}
			if ( isset( $_POST['_movedo_grve_post_slider_settings_direction_nav_color'] ) ) {
				$media_slider_direction_nav_color = sanitize_text_field( $_POST['_movedo_grve_post_slider_settings_direction_nav_color'] );
			}
