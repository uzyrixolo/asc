...
if ( ! defined( 'MOVEDO_EXT_VERSION' ) ) {
	define( 'MOVEDO_EXT_VERSION', '3.6.1' );
}
...
if ( ! class_exists( 'Movedo_Extension_Plugin' ) ) {
	...
	class Movedo_Extension_Plugin {
		...
		private function __construct() {
			...
			require_once MOVEDO_EXT_PLUGIN_DIR_PATH . 'includes/movedo-ext-metaboxes.php';
			require_once MOVEDO_EXT_PLUGIN_DIR_PATH . 'includes/movedo-ext-login-functions.php';
			...
			if( function_exists( 'vc_lean_map' ) || function_exists( 'vc_map' ) ) {
				...
				require_once MOVEDO_EXT_PLUGIN_DIR_PATH . 'shortcodes/movedo_privacy_gtracking.php';
				require_once MOVEDO_EXT_PLUGIN_DIR_PATH . 'shortcodes/movedo_privacy_gmaps.php';
				require_once MOVEDO_EXT_PLUGIN_DIR_PATH . 'shortcodes/movedo_privacy_gfonts.php';
				require_once MOVEDO_EXT_PLUGIN_DIR_PATH . 'shortcodes/movedo_privacy_video_embeds.php';
				require_once MOVEDO_EXT_PLUGIN_DIR_PATH . 'shortcodes/movedo_privacy_required.php';
				require_once MOVEDO_EXT_PLUGIN_DIR_PATH . 'shortcodes/movedo_privacy_custom.php';
				require_once MOVEDO_EXT_PLUGIN_DIR_PATH . 'shortcodes/movedo_privacy_policy_page_link.php';
				require_once MOVEDO_EXT_PLUGIN_DIR_PATH . 'shortcodes/movedo_privacy_preferences_link.php';
	 ...
	 * Global
	 */
	require_once MOVEDO_EXT_PLUGIN_DIR_PATH . 'includes/movedo-ext-global-functions.php';

	/**
	 * Widgets
	 */
	function movedo_ext_register_widgets() {
		require_once MOVEDO_EXT_PLUGIN_DIR_PATH . 'widgets/grve-widget-contact-info.php';
		require_once MOVEDO_EXT_PLUGIN_DIR_PATH . 'widgets/grve-widget-image-banner.php';
		require_once MOVEDO_EXT_PLUGIN_DIR_PATH . 'widgets/grve-widget-latest-comments.php';
		require_once MOVEDO_EXT_PLUGIN_DIR_PATH . 'widgets/grve-widget-latest-portfolio.php';
		require_once MOVEDO_EXT_PLUGIN_DIR_PATH . 'widgets/grve-widget-latest-posts.php';
		require_once MOVEDO_EXT_PLUGIN_DIR_PATH . 'widgets/grve-widget-social.php';
		require_once MOVEDO_EXT_PLUGIN_DIR_PATH . 'widgets/grve-widget-sticky.php';
		register_widget( 'Movedo_Ext_Widget_Contact_Info' );
		register_widget( 'Movedo_Ext_Widget_Image_Banner' );
		register_widget( 'Movedo_Ext_Widget_Latest_Portfolio' );
		register_widget( 'Movedo_Ext_Widget_Latest_Posts' );
		register_widget( 'Movedo_Ext_Widget_Latest_Comments' );
		register_widget( 'Movedo_Ext_Widget_Social' );
		register_widget( 'Movedo_Ext_Widget_Sticky' );
	}
	add_action( 'widgets_init', 'movedo_ext_register_widgets' );

	/**
	 *Admin Menu
	 */
	require_once MOVEDO_EXT_PLUGIN_DIR_PATH . 'includes/admin/movedo-ext-admin-functions.php';
}
