...
if ( function_exists( 'vc_add_shortcode_param' ) ) {
	...
	if ( ! function_exists( 'movedo_ext_vce_label' ) ) {
		function movedo_ext_vce_label( $param, $param_value ) {
			return  '<div class="grve-param-label">' .
					'<input class="wpb_vc_param_value '. esc_attr( $param['param_name'] ) . ' ' . esc_attr( $param['type'] ) . '_field" type="hidden" value="' . esc_attr( $param_value ) . '" name="' . esc_attr( $param['param_name'] ) . '"/>' .
					'</div>';
		}
		vc_add_shortcode_param( 'movedo_param_label', 'movedo_ext_vce_label' );
	}	
