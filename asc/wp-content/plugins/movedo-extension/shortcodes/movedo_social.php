		...
		?>
			<div class="<?php echo esc_attr( $social_class_string ); ?>" style="<?php echo $style; ?>"<?php echo $data; ?>>
				<ul>
					...
					<li><a href="<?php echo esc_url( $page_email_string ); ?>" title="<?php echo esc_attr( $movedo_ext_title ); ?>" class="<?php echo esc_attr( $social_shape_class_string ); ?> grve-social-share-email" aria-label="<?php echo esc_attr__( "Share with E-mail", "movedo-extension" ); ?>"><i class="grve-text-<?php echo esc_attr( $icon_color ); ?> fas fa-envelope"></i></a></li>
					<?php } ?>
					<?php if ( !empty( $social_facebook ) ) { ?>
					<li><a href="<?php echo esc_url( $movedo_ext_permalink ); ?>" title="<?php echo esc_attr( $movedo_ext_title ); ?>" class="<?php echo esc_attr( $social_shape_class_string ); ?> grve-social-share-facebook" aria-label="<?php echo esc_attr__( "Share on Facebook", "movedo-extension" ); ?>"><i class="grve-text-<?php echo esc_attr( $icon_color ); ?> fab fa-facebook"></i></a></li>
					<?php } ?>
					<?php if ( !empty( $social_twitter ) ) { ?>
					<li><a href="<?php echo esc_url( $movedo_ext_permalink ); ?>" title="<?php echo esc_attr( $movedo_ext_title ); ?>" class="<?php echo esc_attr( $social_shape_class_string ); ?> grve-social-share-twitter" aria-label="<?php echo esc_attr__( "Share on X", "movedo-extension" ); ?>"><i class="grve-text-<?php echo esc_attr( $icon_color ); ?> fab fa-x-twitter"></i></a></li>
					<?php } ?>
					<?php if ( !empty( $social_linkedin ) ) { ?>
					<li><a href="<?php echo esc_url( $movedo_ext_permalink ); ?>" title="<?php echo esc_attr( $movedo_ext_title ); ?>" class="<?php echo esc_attr( $social_shape_class_string ); ?> grve-social-share-linkedin" aria-label="<?php echo esc_attr__( "Share on Linkedin", "movedo-extension" ); ?>"><i class="grve-text-<?php echo esc_attr( $icon_color ); ?> fab fa-linkedin"></i></a></li>
					<?php } ?>
					<?php if ( !empty( $social_reddit ) ) { ?>
					<li><a href="<?php echo esc_url( $movedo_ext_permalink ); ?>" title="<?php echo esc_attr( $movedo_ext_title ); ?>" class="<?php echo esc_attr( $social_shape_class_string ); ?> grve-social-share-reddit" aria-label="<?php echo esc_attr__( "Submit on reddit", "movedo-extension" ); ?>"><i class="grve-text-<?php echo esc_attr( $icon_color ); ?> fab fa-reddit"></i></a></li>
					<?php } ?>
					<?php if ( !empty( $social_pinterest  ) ) { ?>
					<li><a href="<?php echo esc_url( $movedo_ext_permalink ); ?>" title="<?php echo esc_attr( $movedo_ext_title ); ?>" class="<?php echo esc_attr( $social_shape_class_string ); ?> grve-social-share-pinterest" data-pin-img="<?php echo esc_url( $movedo_ext_image_url ); ?>" aria-label="<?php echo esc_attr__( "Submit on Pinterest", "movedo-extension" ); ?>"><i class="grve-text-<?php echo esc_attr( $icon_color ); ?> fab fa-pinterest"></i></a></li>
					<?php } ?>
					<?php if ( !empty( $social_tumblr  ) ) { ?>
					<li><a href="<?php echo esc_url( $movedo_ext_permalink ); ?>" title="<?php echo esc_attr( $movedo_ext_title ); ?>" class="<?php echo esc_attr( $social_shape_class_string ); ?> grve-social-share-tumblr" aria-label="<?php echo esc_attr__( "Submit on Tumblr", "movedo-extension" ); ?>"><i class="grve-text-<?php echo esc_attr( $icon_color ); ?> fab fa-tumblr"></i></a></li>
					<?php } ?>
					...
					<?php if ( !empty( $likes ) && function_exists( 'movedo_grve_likes' ) ) {
						...
						$post_id = $post->ID;
					?>
					<li><a href="#" class="<?php echo esc_attr( $social_shape_class_string ); ?> grve-like-counter-link" data-post-id="<?php echo esc_attr( $post_id ); ?>"><i class="grve-text-<?php echo esc_attr( $icon_color ); ?> fas fa-heart"></i><span class="grve-like-counter"><?php echo movedo_grve_likes( $post_id, 'number' ); ?></span></a></li>
					<?php } ?>
		...
		return array(
			...
			"params" => array(
				...
				array(
					...
					"description" => esc_html__( "Share on Facebook", "movedo-extension" ),
					"value" => array( esc_html__( "Show Facebook social share", "movedo-extension" ) => 'yes' ),
				),
				array(
					"type" => 'checkbox',
					"heading" => esc_html__( "Twitter (X)", "movedo-extension" ),
					"param_name" => "social_twitter",
					"description" => esc_html__( "Share on Twitter (X)", "movedo-extension" ),
					"value" => array( esc_html__( "Show Twitter (X) social share", "movedo-extension" ) => 'yes' ),
				),
				array(
					"type" => 'checkbox',
					"heading" => esc_html__( "Linkedin", "movedo-extension" ),
					"param_name" => "social_linkedin",
					"description" => esc_html__( "Share on Linkedin", "movedo-extension" ),
				...
				array(
					...
					"description" => esc_html__( "Submit on reddit", "movedo-extension" ),
				...
				array(
					...
					"description" => esc_html__( "Submit on Pinterest (Featured Image is used as image)", "movedo-extension" ),
				...
				array(
					...
					"description" => esc_html__( "Submit on Tumblr", "movedo-extension" ),
