...
if( !function_exists( 'movedo_ext_vce_team_shortcode' ) ) {
	...
	function movedo_ext_vce_team_shortcode( $attr, $content ) {
		...
		if ( !empty( $social_facebook ) ) {
			$links .= '<li><a href="' . esc_url( $social_facebook ) . '" target="_blank" rel="' . implode( ' ', $social_rel ) . '" class="' . esc_attr( $link_class_string ) . '"><i class="fab fa-facebook"></i></a></li>';
		}
		if ( !empty( $social_twitter ) ) {
			$links .= '<li><a href="' . esc_url( $social_twitter ) . '" target="_blank" rel="' . implode( ' ', $social_rel ) . '" class="' . esc_attr( $link_class_string ) . '"><i class="fab fa-x-twitter"></i></a></li>';
		}
		if ( !empty( $social_linkedin ) ) {
			$links .= '<li><a href="' . esc_url( $social_linkedin ) . '" target="_blank" rel="' . implode( ' ', $social_rel ) . '" class="' . esc_attr( $link_class_string ) . '"><i class="fab fa-linkedin"></i></a></li>';
		}
		if ( !empty( $social_xing ) ) {
			$links .= '<li><a href="' . esc_url( $social_xing ) . '" target="_blank" rel="' . implode( ' ', $social_rel ) . '" class="' . esc_attr( $link_class_string ) . '"><i class="fab fa-xing"></i></a></li>';
		}
		if ( !empty( $social_instagram ) ) {
			$links .= '<li><a href="' . esc_url( $social_instagram ) . '" target="_blank" rel="' . implode( ' ', $social_rel ) . '" class="' . esc_attr( $link_class_string ) . '"><i class="fab fa-instagram"></i></a></li>';
		}
		if ( !empty( $social_youtube ) ) {
			$links .= '<li><a href="' . esc_url( $social_youtube ) . '" target="_blank" rel="' . implode( ' ', $social_rel ) . '" class="' . esc_attr( $link_class_string ) . '"><i class="fab fa-youtube"></i></a></li>';
		}
		if ( !empty( $social_vimeo ) ) {
			$links .= '<li><a href="' . esc_url( $social_vimeo ) . '" target="_blank" rel="' . implode( ' ', $social_rel ) . '" class="' . esc_attr( $link_class_string ) . '"><i class="fab fa-vimeo"></i></a></li>';
		}
		if ( !empty( $email ) ) {
		...
		return array(
			...
			"params" => array(
				...
				array(
					...
					"value" => "",
					"description" => esc_html__( "Enter Twitter (X) URL. Clear input if you don't want to display.", "movedo-extension" ),
					"group" => esc_html__( "Socials & Link", "movedo-extension" ),
				),
				array(
					"type" => "textfield",
				...
				array(
					"type" => "textfield",
					"heading" => esc_html__( "Xing", "movedo-extension" ),
					"param_name" => "social_xing",
					"value" => "",
					"description" => esc_html__( "Enter Xing URL. Clear input if you don't want to display.", "movedo-extension" ),
					"group" => esc_html__( "Socials & Link", "movedo-extension" ),
				),
				array(
					"type" => "textfield",
