		...
		if ( 'carousel' == $gallery_mode ) {
			...
			foreach ( $attachments as $id ) {
				...
				if( 'yes' == $show_title ){
					...
					$link_data .= ' aria-label="' . esc_attr( $image_title ) . '"';
				}
				if( 'yes' == $show_caption ){
...
if ( class_exists( 'WPBakeryShortCode' ) ) {
	class WPBakeryShortCode_Movedo_Gallery extends WPBakeryShortCode {
		...
		return array(
			...
			"params" => array(
				...
				array(
					...
					'heading' => esc_html__( 'Custom links', 'movedo-extension' ),
					'param_name' => 'custom_links',
					'description' => esc_html__( 'Enter links for each slide (Note: divide links with linebreaks (Enter)).', 'movedo-extension' ),
					'dependency' => array(
				...
				array(
					'type' => 'dropdown',
					'heading' => esc_html__( 'Custom link target', 'movedo-extension' ),
					'param_name' => 'custom_links_target',
					'description' => esc_html__( 'Select where to open custom links.', 'movedo-extension' ),
					'dependency' => array(
						'element' => 'image_link_mode',
						'value' => array( 'custom_link' ),
					),
				...
				array(
					...
					'heading' => esc_html__( 'Filter categories', 'movedo-extension' ),
					'param_name' => 'filter_values',
					'description' => esc_html__( 'Enter categories for each image (Note: divide categories with |, separate images with linebreaks (Enter)).', 'movedo-extension' ),
